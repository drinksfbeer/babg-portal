...
import VisualBuilderSection from './blogPostBuilderSection';
...
class BlogPostBuilderForm extends React.Component {
  onDragEnd = (result) => {
    const {
      fields,
    } = this.props;
...
BlogPostBuilderForm.propTypes = {
  fields: PropTypes.shape({}),
  sectionsFromStore: PropTypes.arrayOf(PropTypes.shape({})).isRequired,
};

BlogPostBuilderForm.defaultProps = {
  fields: {},
};

export default BlogPostBuilderForm;
